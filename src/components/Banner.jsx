...
export const Banner = () => {
  return (
    <div id="template-mo-Michael-hero-carousel" className="carousel slide" data-bs-ride="carousel">
    <ol className="carousel-indicators">
        <li data-bs-target="#template-mo-Michael-hero-carousel" data-bs-slide-to="0" className="active"></li>
        <li data-bs-target="#template-mo-Michael-hero-carousel" data-bs-slide-to="1"></li>
        <li data-bs-target="#template-mo-Michael-hero-carousel" data-bs-slide-to="2"></li>
    </ol>
                ...
                <div className="row p-5">
                    ...
                    <div className="col-lg-6 mb-0 d-flex align-items-center">
                        <div className="text-align-left align-self-center">
                            <h1 className="h1 text-success"><b>Michael</b> eCommerce</h1>
                            <h3 className="h2">Tiny and Perfect eCommerce Template</h3>
                            <p>
                                Michael Shop is an eCommerce HTML5 CSS template with latest version of Bootstrap 5 (beta 1). 
                ...
                <div className="row p-5">
                    ...
                    <div className="col-lg-6 mb-0 d-flex align-items-center">
                        <div className="text-align-left">
                            ...
                            <p>
                                You are permitted to use this Michael CSS template for your commercial websites. 
    ...
    <a className="carousel-control-prev text-decoration-none w-auto ps-3" href="#template-mo-Michael-hero-carousel" role="button" data-bs-slide="prev">
        <i className="fas fa-chevron-left"></i>
    </a>
    <a className="carousel-control-next text-decoration-none w-auto pe-3" href="#template-mo-Michael-hero-carousel" role="button" data-bs-slide="next">
